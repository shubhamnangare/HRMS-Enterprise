        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OvertimeHours = table.Column<decimal>(type: "numeric(5,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    LateMinutes = table.Column<decimal>(type: "numeric(5,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobGrade = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_Entity_EntityId_Action",
                table: "AuditLogs",
                columns: new[] { "Entity", "EntityId", "Action" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_DateRange",
                table: "LeaveRequests",
                columns: new[] { "StartDate", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_Employee_Status_Date",
                table: "LeaveRequests",
